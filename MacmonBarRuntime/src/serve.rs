...
fn to_prometheus(m: &Metrics, soc: &SocInfo) -> String {
  ...
  gauge!(out, "macmon_network_download_bytes_per_second", "Aggregate non-loopback network download throughput in bytes per second", m.network.download_bytes_per_second);
  gauge!(out, "macmon_network_upload_bytes_per_second", "Aggregate non-loopback network upload throughput in bytes per second", m.network.upload_bytes_per_second);
  gauge!(out, "macmon_network_received_bytes", "Aggregate non-loopback network received bytes", m.network.received_bytes);
  gauge!(out, "macmon_network_transmitted_bytes", "Aggregate non-loopback network transmitted bytes", m.network.transmitted_bytes);
