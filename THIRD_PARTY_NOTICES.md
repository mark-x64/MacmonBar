...
- Bundled path: `MacmonBar.app/Contents/Resources/bin/macmon`
- License: MIT
- Copyright: See `macmon/LICENSE`

The upstream MIT license text is copied into release app bundles at:
